...
func main() {
	...
	kafkaConsumer.RegisterType("order-placed",&messaging.OrderPlaced{})
	...
	r.HandleFunc("/products/{product_id}", productAPIHandler.GetProductByIdHandler).Methods("GET")    // Update product
