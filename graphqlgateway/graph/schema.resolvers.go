...
// Resolver struct that will hold the resolvers
type Resolver struct{}

// MutationResolver struct that implements mutation resolver
type mutationResolver struct{ *Resolver }

// QueryResolver struct that implements query resolver
